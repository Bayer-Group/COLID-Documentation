...
* https://pid.bayer.com/kos/19050/shacl/fieldType

### Distinction between field types as instances

* https://pid.bayer.com/kos/19050/shacl/fieldType#string
    + The field type string provides the user with a input field of type string. All characters may be entered.
* https://pid.bayer.com/kos/19050/shacl/fieldType#naturalNumber
...
* https://pid.bayer.com/kos/19050/shacl/fieldType#number
...
* https://pid.bayer.com/kos/19050/shacl/fieldType#html
...
* https://pid.bayer.com/kos/19050/shacl/fieldType#boolean
...
* https://pid.bayer.com/kos/19050/shacl/fieldType#list
...
* https://pid.bayer.com/kos/19050/shacl/fieldType#hierarchy
    + The field type hierarchy provides the user with a input field of type select. In the SHACLs must be defined that it is the nodekind IRI and has a range like `https://pid.bayer.com/kos/19050/shacl/fieldType#list`. This field type should only be used for taxonomies.

* https://pid.bayer.com/kos/19050/shacl/fieldType#identifier
...
* https://pid.bayer.com/kos/19050/shacl/fieldType#entity
...
* https://pid.bayer.com/kos/19050/shacl/fieldType#linkedEntity
...
If the field type is defined as `https://pid.bayer.com/kos/19050/shacl/fieldType#list` or `https://pid.bayer.com/kos/19050/shacl/fieldType#hierarchy`. This is a selection field in the ui.  This gives the user the possibility to select a pre-selected number of options. If the SHACL for maxCount `http://www.w3.org/ns/shacl#maxCount` is larger than 1, the field is used as multiselect, otherwise single selection possible only.

### Multi Value Input - string only

If the field type is defined as `https://pid.bayer.com/kos/19050/shacl/fieldType#string` and the SHACL for maxCount ``http://www.w3.org/ns/shacl#maxCount` is larger than 1, the user can add multiple values for this input field.
...
Although input fields of type `https://pid.bayer.com/kos/19050/shacl/fieldType#number` or `https://pid.bayer.com/kos/19050/shacl/fieldType#decimal` are also displayed for the following data types, it can lead to problems as described above:
